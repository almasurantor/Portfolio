...
const Navbar = () => {
  ...
  return (
    ...
    <div className='w-screen hidden md:flex items-center justify-center py-4 fixed top-0 z-10'>
      <nav className='max-w-screen-xl  bg-navbg rounded-xl shadow-lg shadow-sky-600/10 max-auto py-3 px-6'> 
    ...
    <div className='p-3 fixed top-0 right-0 z-50'>
        <button onClick={toggleMenu} className='w-11 h-11 text-2xl text-sky-300 bg-blue-800/40 border border-sky-900/40 backdrop-blur-lg flex items-center justify-center rounded md:hidden z-50 ml-auto'>
